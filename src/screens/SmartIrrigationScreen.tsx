...
const SmartIrrigationScreen = ({ navigation }) => {
  ...
  const reverseGeocode = async (latitude, longitude) => {
    try {
      const response = await fetch(
        ...
        {
          headers: {
            'User-Agent': 'SmartIrrigationApp/1.0'
          }
        }
      );
  ...
  const fetchExpertReports = async () => {
    ...
    try {
      ...
      const response = await fetch(`${BASE_URL}/farmer/expert-reports/smart-irrigation`, {
        method: 'GET',
        headers: {
      ...
      <View style={styles.modalOverlay}>
        <View style={styles.reportsModal}>
          <View style={styles.modalHeader}>
            <Text style={styles.modalTitle}>Expert Reports</Text>
            <TouchableOpacity
          ...
          {loadingReports ? (
            ...
            <View style={styles.emptyReportsView}>
              ...
              <Text style={styles.emptyReportsText}>No expert reports available</Text>
              <Text style={styles.emptyReportsSubtext}>
                Expert reports will appear here once available
              </Text>
            </View>
          )}
        </View>
